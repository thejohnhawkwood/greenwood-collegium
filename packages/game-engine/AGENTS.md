...
- Ticket 015 owns Arrival at the Collegium, `help`, `quests`, `spells`, and one-time quest rewards. Join auto-look does not complete the look objective. Year-marks raise max health and focus. Investigation quests may award a personal item.

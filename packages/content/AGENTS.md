...
- ADR-0048: `college-raider` is an enemy template with no placement. A defense mints it at the three gates at runtime, so its stats stay in JSON. `raiders-token` is its loot. Do not add a placement for it.

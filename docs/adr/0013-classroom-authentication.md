...
- Unused classroom invite plaintext is recoverable by owner and teacher. After consume, the teacher roster still keeps the issued token and hash so a private class list can be joined to username and Collegian. Students never receive tokens. See ADR-0020.

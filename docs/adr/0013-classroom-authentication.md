...
- Unused classroom invite plaintext is recoverable by owner and teacher. After consume the token cannot be used again, but the plaintext stays on the invite row for the teacher roster. See ADR-0020.

...
- `/health/ready` stays unready (503) until the database is used and content can load. Ticket 008 may remove `database unwired` after a successful ping. Ticket 011 may report ready when the database pings and content loads.

...
- **Active follow-up:** confirm the live Render deploy. Talk to Porter, use a dialogue button, Tab-complete, and open Inventory. Do not start DS-005 quest tracker or DS-007 combat frame unless the owner names it.

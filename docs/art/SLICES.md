...
3. **Foes still missing.** Integrated 25 September 2026. Archive bat `v001`, withy sentry `v001`. College raiders are four plates: fox `v003`, badger, rat, and stoat. A `defense-` spawn id keeps one of those four. The fox is snarling; the pry-bar stays a bar.
